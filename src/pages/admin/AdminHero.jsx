...
const FIELD_LABELS = {
  scrollLabel: 'Libellé du bouton scroll',
};
  ...
  return (
    <div className="admin-page">
      ...
      <p className="admin-page__lead">
        Texte du bouton de défilement sous la section d&apos;accueil. L&apos;eyebrow
      ...
      <form className="admin-form admin-form--wide" onSubmit={handleSave}>
        {Object.keys(DEFAULT_HERO).map((field) => (
          <label key={field} className="admin-form__field">
            ...
            <input
              ...
              placeholder={DEFAULT_HERO[field] || undefined}
            />
          </label>
        ))}
